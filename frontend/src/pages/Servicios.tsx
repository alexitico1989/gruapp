        ...
        <div className="max-w-[1300px] mx-auto px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
              <div className="w-20 h-20 bg-[#ff7a3d] bg-opacity-10 rounded-xl flex items-center justify-center mb-6">
                <GiTowTruck className="w-12 h-12 text-[#ff7a3d]" />
              </div>
              <h3 className="text-3xl font-bold text-[#1e3a5f] mb-4">Grúa Cama Baja</h3>
              ...
              <h4 className="font-bold text-[#1e3a5f] mb-3">Características:</h4>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
              ...
              <h3 className="text-3xl font-bold text-[#1e3a5f] mb-4">Grúa Horquilla</h3>
              <p className="text-gray-600 mb-6 leading-relaxed text-lg">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
              ...
              <h3 className="text-3xl font-bold text-[#1e3a5f] mb-4">Grúa Pluma</h3>
              <p className="text-gray-600 mb-6 leading-relaxed text-lg">
