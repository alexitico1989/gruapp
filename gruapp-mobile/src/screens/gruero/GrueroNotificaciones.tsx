...
export default function GrueroNotificaciones() {
  ...
  const getIconoNotificacion = (tipo: string) => {
    const iconos: Record<string, { name: string; color: string; bg: string }> = {
      NUEVO_SERVICIO: { name: 'car-sport', color: '#3b82f6', bg: '#f0f9ff' },
      SERVICIO_CANCELADO: { name: 'close-circle', color: '#ef4444', bg: '#fef2f2' },
      SERVICIO_COMPLETADO: { name: 'checkmark-done-circle', color: '#10b981', bg: '#f0fdf4' },
      PAGO_RECIBIDO: { name: 'cash', color: '#10b981', bg: '#f0fdf4' },
      CALIFICACION_RECIBIDA: { name: 'star', color: '#f59e0b', bg: '#fffbeb' },
